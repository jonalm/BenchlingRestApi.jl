...
@doc raw"""DnaOligoWithEntityType
    ...
    - entityType::String
"""
Base.@kwdef mutable struct DnaOligoWithEntityType <: OpenAPI.APIModel
    ...
    function DnaOligoWithEntityType(aliases, apiURL, archiveRecord, bases, createdAt, creator, customFields, entityRegistryId, fields, folderId, id, length, modifiedAt, name, nucleotideType, registrationOrigin, registryId, schema, webURL, annotations, customNotation, customNotationName, helm, entityType, )
        OpenAPI.validate_property(DnaOligoWithEntityType, Symbol("aliases"), aliases)
        OpenAPI.validate_property(DnaOligoWithEntityType, Symbol("apiURL"), apiURL)
        OpenAPI.validate_property(DnaOligoWithEntityType, Symbol("archiveRecord"), archiveRecord)
        OpenAPI.validate_property(DnaOligoWithEntityType, Symbol("bases"), bases)
        OpenAPI.validate_property(DnaOligoWithEntityType, Symbol("createdAt"), createdAt)
        OpenAPI.validate_property(DnaOligoWithEntityType, Symbol("creator"), creator)
        OpenAPI.validate_property(DnaOligoWithEntityType, Symbol("customFields"), customFields)
        OpenAPI.validate_property(DnaOligoWithEntityType, Symbol("entityRegistryId"), entityRegistryId)
        OpenAPI.validate_property(DnaOligoWithEntityType, Symbol("fields"), fields)
        OpenAPI.validate_property(DnaOligoWithEntityType, Symbol("folderId"), folderId)
        OpenAPI.validate_property(DnaOligoWithEntityType, Symbol("id"), id)
        OpenAPI.validate_property(DnaOligoWithEntityType, Symbol("length"), length)
        OpenAPI.validate_property(DnaOligoWithEntityType, Symbol("modifiedAt"), modifiedAt)
        OpenAPI.validate_property(DnaOligoWithEntityType, Symbol("name"), name)
        OpenAPI.validate_property(DnaOligoWithEntityType, Symbol("nucleotideType"), nucleotideType)
        OpenAPI.validate_property(DnaOligoWithEntityType, Symbol("registrationOrigin"), registrationOrigin)
        OpenAPI.validate_property(DnaOligoWithEntityType, Symbol("registryId"), registryId)
        OpenAPI.validate_property(DnaOligoWithEntityType, Symbol("schema"), schema)
        OpenAPI.validate_property(DnaOligoWithEntityType, Symbol("webURL"), webURL)
        OpenAPI.validate_property(DnaOligoWithEntityType, Symbol("annotations"), annotations)
        OpenAPI.validate_property(DnaOligoWithEntityType, Symbol("customNotation"), customNotation)
        OpenAPI.validate_property(DnaOligoWithEntityType, Symbol("customNotationName"), customNotationName)
        OpenAPI.validate_property(DnaOligoWithEntityType, Symbol("helm"), helm)
        OpenAPI.validate_property(DnaOligoWithEntityType, Symbol("entityType"), entityType)
