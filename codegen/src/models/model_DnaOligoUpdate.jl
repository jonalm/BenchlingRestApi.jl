...
"""
Base.@kwdef mutable struct DnaOligoUpdate <: OpenAPI.APIModel
    ...
    function DnaOligoUpdate(aliases, authorIds, bases, customFields, fields, folderId, name, schemaId, annotations, helm, customNotation, customNotationId, )
        OpenAPI.validate_property(DnaOligoUpdate, Symbol("aliases"), aliases)
        OpenAPI.validate_property(DnaOligoUpdate, Symbol("authorIds"), authorIds)
        OpenAPI.validate_property(DnaOligoUpdate, Symbol("bases"), bases)
        OpenAPI.validate_property(DnaOligoUpdate, Symbol("customFields"), customFields)
        OpenAPI.validate_property(DnaOligoUpdate, Symbol("fields"), fields)
        OpenAPI.validate_property(DnaOligoUpdate, Symbol("folderId"), folderId)
        OpenAPI.validate_property(DnaOligoUpdate, Symbol("name"), name)
        OpenAPI.validate_property(DnaOligoUpdate, Symbol("schemaId"), schemaId)
        OpenAPI.validate_property(DnaOligoUpdate, Symbol("annotations"), annotations)
        OpenAPI.validate_property(DnaOligoUpdate, Symbol("helm"), helm)
        OpenAPI.validate_property(DnaOligoUpdate, Symbol("customNotation"), customNotation)
        OpenAPI.validate_property(DnaOligoUpdate, Symbol("customNotationId"), customNotationId)
...
end # type DnaOligoUpdate

const _property_types_DnaOligoUpdate = Dict{Symbol,String}(Symbol("aliases")=>"Vector{String}", Symbol("authorIds")=>"Vector{String}", Symbol("bases")=>"String", Symbol("customFields")=>"Dict{String, CustomField}", Symbol("fields")=>"Dict{String, Field}", Symbol("folderId")=>"String", Symbol("name")=>"String", Symbol("schemaId")=>"String", Symbol("annotations")=>"Vector{DnaAnnotation}", Symbol("helm")=>"String", Symbol("customNotation")=>"String", Symbol("customNotationId")=>"String", )
OpenAPI.property_type(::Type{ DnaOligoUpdate }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_DnaOligoUpdate[name]))}

function check_required(o::DnaOligoUpdate)
    true
end

function OpenAPI.validate_property(::Type{ DnaOligoUpdate }, name::Symbol, val)
end
