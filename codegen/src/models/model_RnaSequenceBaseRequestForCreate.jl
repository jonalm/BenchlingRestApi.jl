...
@doc raw"""RnaSequenceBaseRequestForCreate
...
"""
Base.@kwdef mutable struct RnaSequenceBaseRequestForCreate <: OpenAPI.APIModel
    ...
    function RnaSequenceBaseRequestForCreate(aliases, annotations, authorIds, bases, customFields, fields, folderId, isCircular, name, parts, primers, schemaId, translations, )
        OpenAPI.validate_property(RnaSequenceBaseRequestForCreate, Symbol("aliases"), aliases)
        OpenAPI.validate_property(RnaSequenceBaseRequestForCreate, Symbol("annotations"), annotations)
        OpenAPI.validate_property(RnaSequenceBaseRequestForCreate, Symbol("authorIds"), authorIds)
        OpenAPI.validate_property(RnaSequenceBaseRequestForCreate, Symbol("bases"), bases)
        OpenAPI.validate_property(RnaSequenceBaseRequestForCreate, Symbol("customFields"), customFields)
        OpenAPI.validate_property(RnaSequenceBaseRequestForCreate, Symbol("fields"), fields)
        OpenAPI.validate_property(RnaSequenceBaseRequestForCreate, Symbol("folderId"), folderId)
        OpenAPI.validate_property(RnaSequenceBaseRequestForCreate, Symbol("isCircular"), isCircular)
        OpenAPI.validate_property(RnaSequenceBaseRequestForCreate, Symbol("name"), name)
        OpenAPI.validate_property(RnaSequenceBaseRequestForCreate, Symbol("parts"), parts)
        OpenAPI.validate_property(RnaSequenceBaseRequestForCreate, Symbol("primers"), primers)
        OpenAPI.validate_property(RnaSequenceBaseRequestForCreate, Symbol("schemaId"), schemaId)
        OpenAPI.validate_property(RnaSequenceBaseRequestForCreate, Symbol("translations"), translations)
