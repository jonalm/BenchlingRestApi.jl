...
@doc raw"""CustomEntityBulkCreate
...
"""
Base.@kwdef mutable struct CustomEntityBulkCreate <: OpenAPI.APIModel
    ...
    function CustomEntityBulkCreate(aliases, authorIds, customFields, fields, folderId, name, schemaId, entityRegistryId, namingStrategy, registryId, )
        OpenAPI.validate_property(CustomEntityBulkCreate, Symbol("aliases"), aliases)
        OpenAPI.validate_property(CustomEntityBulkCreate, Symbol("authorIds"), authorIds)
        OpenAPI.validate_property(CustomEntityBulkCreate, Symbol("customFields"), customFields)
        OpenAPI.validate_property(CustomEntityBulkCreate, Symbol("fields"), fields)
        OpenAPI.validate_property(CustomEntityBulkCreate, Symbol("folderId"), folderId)
        OpenAPI.validate_property(CustomEntityBulkCreate, Symbol("name"), name)
        OpenAPI.validate_property(CustomEntityBulkCreate, Symbol("schemaId"), schemaId)
        OpenAPI.validate_property(CustomEntityBulkCreate, Symbol("entityRegistryId"), entityRegistryId)
        OpenAPI.validate_property(CustomEntityBulkCreate, Symbol("namingStrategy"), namingStrategy)
        OpenAPI.validate_property(CustomEntityBulkCreate, Symbol("registryId"), registryId)
        return new(aliases, authorIds, customFields, fields, folderId, name, schemaId, entityRegistryId, namingStrategy, registryId, )
    end
end # type CustomEntityBulkCreate

const _property_types_CustomEntityBulkCreate = Dict{Symbol,String}(Symbol("aliases")=>"Vector{String}", Symbol("authorIds")=>"Vector{String}", Symbol("customFields")=>"Dict{String, CustomField}", Symbol("fields")=>"Dict{String, Field}", Symbol("folderId")=>"String", Symbol("name")=>"String", Symbol("schemaId")=>"String", Symbol("entityRegistryId")=>"String", Symbol("namingStrategy")=>"NamingStrategy", Symbol("registryId")=>"String", )
OpenAPI.property_type(::Type{ CustomEntityBulkCreate }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_CustomEntityBulkCreate[name]))}

function check_required(o::CustomEntityBulkCreate)
    o.name === nothing && (return false)
    o.schemaId === nothing && (return false)
    true
end

function OpenAPI.validate_property(::Type{ CustomEntityBulkCreate }, name::Symbol, val)
end
