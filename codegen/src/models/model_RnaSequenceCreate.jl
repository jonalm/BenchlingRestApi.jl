...
"""
Base.@kwdef mutable struct RnaSequenceCreate <: OpenAPI.APIModel
    ...
    function RnaSequenceCreate(aliases, annotations, authorIds, bases, customFields, fields, folderId, isCircular, name, parts, primers, schemaId, translations, entityRegistryId, namingStrategy, registryId, )
        OpenAPI.validate_property(RnaSequenceCreate, Symbol("aliases"), aliases)
        OpenAPI.validate_property(RnaSequenceCreate, Symbol("annotations"), annotations)
        OpenAPI.validate_property(RnaSequenceCreate, Symbol("authorIds"), authorIds)
        OpenAPI.validate_property(RnaSequenceCreate, Symbol("bases"), bases)
        OpenAPI.validate_property(RnaSequenceCreate, Symbol("customFields"), customFields)
        OpenAPI.validate_property(RnaSequenceCreate, Symbol("fields"), fields)
        OpenAPI.validate_property(RnaSequenceCreate, Symbol("folderId"), folderId)
        OpenAPI.validate_property(RnaSequenceCreate, Symbol("isCircular"), isCircular)
        OpenAPI.validate_property(RnaSequenceCreate, Symbol("name"), name)
        OpenAPI.validate_property(RnaSequenceCreate, Symbol("parts"), parts)
        OpenAPI.validate_property(RnaSequenceCreate, Symbol("primers"), primers)
        OpenAPI.validate_property(RnaSequenceCreate, Symbol("schemaId"), schemaId)
        OpenAPI.validate_property(RnaSequenceCreate, Symbol("translations"), translations)
        OpenAPI.validate_property(RnaSequenceCreate, Symbol("entityRegistryId"), entityRegistryId)
        OpenAPI.validate_property(RnaSequenceCreate, Symbol("namingStrategy"), namingStrategy)
        OpenAPI.validate_property(RnaSequenceCreate, Symbol("registryId"), registryId)
...
end # type RnaSequenceCreate

const _property_types_RnaSequenceCreate = Dict{Symbol,String}(Symbol("aliases")=>"Vector{String}", Symbol("annotations")=>"Vector{RnaAnnotation}", Symbol("authorIds")=>"Vector{String}", Symbol("bases")=>"String", Symbol("customFields")=>"Dict{String, CustomField}", Symbol("fields")=>"Dict{String, Field}", Symbol("folderId")=>"String", Symbol("isCircular")=>"Bool", Symbol("name")=>"String", Symbol("parts")=>"Vector{RnaSequencePart}", Symbol("primers")=>"Vector{Primer}", Symbol("schemaId")=>"String", Symbol("translations")=>"Vector{Translation}", Symbol("entityRegistryId")=>"String", Symbol("namingStrategy")=>"NamingStrategy", Symbol("registryId")=>"String", )
OpenAPI.property_type(::Type{ RnaSequenceCreate }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_RnaSequenceCreate[name]))}

function check_required(o::RnaSequenceCreate)
    o.bases === nothing && (return false)
    o.name === nothing && (return false)
    true
end

function OpenAPI.validate_property(::Type{ RnaSequenceCreate }, name::Symbol, val)
end
