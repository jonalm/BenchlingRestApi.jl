...
"""
Base.@kwdef mutable struct DnaSequenceBulkCreate <: OpenAPI.APIModel
    ...
    function DnaSequenceBulkCreate(aliases, annotations, authorIds, bases, customFields, fields, folderId, isCircular, name, parts, primers, schemaId, translations, entityRegistryId, namingStrategy, registryId, )
        OpenAPI.validate_property(DnaSequenceBulkCreate, Symbol("aliases"), aliases)
        OpenAPI.validate_property(DnaSequenceBulkCreate, Symbol("annotations"), annotations)
        OpenAPI.validate_property(DnaSequenceBulkCreate, Symbol("authorIds"), authorIds)
        OpenAPI.validate_property(DnaSequenceBulkCreate, Symbol("bases"), bases)
        OpenAPI.validate_property(DnaSequenceBulkCreate, Symbol("customFields"), customFields)
        OpenAPI.validate_property(DnaSequenceBulkCreate, Symbol("fields"), fields)
        OpenAPI.validate_property(DnaSequenceBulkCreate, Symbol("folderId"), folderId)
        OpenAPI.validate_property(DnaSequenceBulkCreate, Symbol("isCircular"), isCircular)
        OpenAPI.validate_property(DnaSequenceBulkCreate, Symbol("name"), name)
        OpenAPI.validate_property(DnaSequenceBulkCreate, Symbol("parts"), parts)
        OpenAPI.validate_property(DnaSequenceBulkCreate, Symbol("primers"), primers)
        OpenAPI.validate_property(DnaSequenceBulkCreate, Symbol("schemaId"), schemaId)
        OpenAPI.validate_property(DnaSequenceBulkCreate, Symbol("translations"), translations)
        OpenAPI.validate_property(DnaSequenceBulkCreate, Symbol("entityRegistryId"), entityRegistryId)
        OpenAPI.validate_property(DnaSequenceBulkCreate, Symbol("namingStrategy"), namingStrategy)
        OpenAPI.validate_property(DnaSequenceBulkCreate, Symbol("registryId"), registryId)
...
function OpenAPI.validate_property(::Type{ DnaSequenceBulkCreate }, name::Symbol, val)
end
